                        ...
                        <form id="students-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("students/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="std_Name">Std Name <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-std_Name"  value="<?php  echo $this->set_field_value('std_Name',""); ?>" type="text" placeholder="Enter Std Name"  required="" name="std_Name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="HEMIS">Hemis <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-HEMIS"  value="<?php  echo $this->set_field_value('HEMIS',""); ?>" type="text" placeholder="Enter Hemis"  required="" name="HEMIS"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
